...
// Array.prototype.findIndex : 배열을 순회하며 각 요소에 대하여 인자로 주어진 콜백함수를 실행하여 그 결과가 참인 첫 번쨰 요소의 인덱스를 반환
...
let result4 = students.find(item => item.name === '요넥스');
console.log(result4);
let result5 = students.find(item => item.name === '핏썸');
console.log(result5);
let result6 = students.findIndex(item => item.name === '요넥스');
console.log(result6);
let result7 = students.findIndex(item => item.name === '핏썸');
console.log(result7);
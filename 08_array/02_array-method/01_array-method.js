...
// inclues : 배열의 해당 요소 포함 여부를 true / false로 리턴
// console.log()foodList.indexOf('수박'); // 안돼는 예문
...
console.log(front);
// console.log(front.splice("yonex", 3, 1));
// console.log(front);

// Array.prtotype.join : 배열을 구분자로 결합하여 문자열로 반환
